          ...
          {showInputFields && (
            <form onSubmit={handleFormSubmit}>
              ...
              <div className='flex mt-4'>
                ...
                <input list={'state'} className='border border-black ml-9 p-2 cursor-pointer pl-3 w-40 borderTop' type="text" value={selectedState} onChange={handleStateChange} required placeholder='Enter State' />
              </div>
              <br />
              <div className='flex '>
